...
def setUp(self):
        ...
        self.new_review = Review(pitch_id=12345,pitch_title='Review for pitchs',image_path="https://image.tmdb.org/t/p/w500/jdjdjdjn",pitch_review='This pitch is the best thing since sliced bread',user = self.user_James )
def tearDown(self):
        Review.query.delete()
        User.query.delete()
